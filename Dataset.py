...
dataBritain = DataFrame([[240.57,21.64,59.76,14.21],[190.99,68.96,114.99,27.44],[177.64,73.87,160.07,33.08],[168.34,77.00,156.74,32.61],[193.69,89.94,187.45,38.74],[202.70,75.68,177.16,37.01],[288.47,67.45,147.93,27.02]], columns=(0,1,2,3))
# Dataset for Nevada. If data is missing a value of 0 is used.
dataNevada = DataFrame([[0.00,468.07,24.18,1.64],[0.00,303.62,9.30,1.17],[0.00,317.16,9.17,1.16],[0.00,350.68,8.89,1.23],[0.00,349.62,8.25,1.05],[0.00,296.72,7.54,0.93],[0.00,448.20,22.53,2.04]], columns=(0,1,2,3))
# Dataset for Macau. If data is missing a value of 0 is used.
dataMacau = DataFrame([[0.23,1088.05,10.69,0.00],[0.04,792.42,2.28,0.00],[0.04,863.39,2.91,0.00],[0.04,958.74,3.08,0.00],[0.03,817.81,3.34,0.00],[0.02,765.75,3.20,0.00],[0.27,1484.64,11.55,0.00]], columns=(0,1,2,3))
# Dataset for Australia. If data is missing a value of 0 is used.
dataAustralia = DataFrame([[0.0, 0.0, 0.0, 0.0],[81.10,423.80,141.15,10.38],[85.67,582.79,166.78,12.94],[74.62,627.52,176.16,13.87],[71.02,600.11,155.18,13.87],[77.74,627.86,146.14,13.73],[0.0, 0.0, 0.0, 0.0]], columns=(0,1,2,3))
#
